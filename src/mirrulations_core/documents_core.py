...
def get_doc_attributes(document_id):
    ...
    logger.debug('Function Successful: % s',
                 'get_doc_attributes: get_doc_attributes successfully called from process_doc',
                 extra=d)
    ...
    if "_" in document_id:
        ...
        logger.debug('Function Successful: % s',
                     'get_doc_attributes: get_doc_attributes successfully called split',
                     extra=d)
        ...
        logger.debug('Returning: %s',
                     'get_doc_attributes: returning the organization, docket_id, and document_id',
                     extra=d)
        ...
        logger.debug('Function Successful: % s',
                     'get_doc_attributes: get_doc_attributes successfully called add_hyphens',
                     extra=d)
...
def add_hyphens(list):
    ...
    """
    logger.debug('Function Successful: % s',
                 'add_hyphens: add_hyphens successfully called from get_doc_attributes',
                 extra=d)
