...
def test_search_document_test_directory_good_document():
    full_path = ds.search_for_document_in_directory("CMS-2019-0006-10896", TEMPATH)
...
def test_search_document_test_directory_good_document_special_case():
    full_path = ds.search_for_document_in_directory("AHRQ_FRDOC_0001-0036", TEMPATH)
...
def test_search_document_test_directory_good_document_orgs_out_of_order():
    full_path = ds.search_for_document_in_directory("USC-RULES-CV-2018-0003-1139", TEMPATH)
...
def test_search_document_test_directory_bad_document():
    full_path = ds.search_for_document_in_directory("CMS-2019-0006-10898", TEMPATH)
    assert full_path == ""


def test_search_document_test_directory_bad_document_special_case():
    full_path = ds.search_for_document_in_directory("AHRQ_FRDOC_0001-0037", TEMPATH)
    assert full_path == ""


def test_search_document_test_directory_bad_document_orgs_out_of_order():
    full_path = ds.search_for_document_in_directory("USC-RULES-CV-2018-0003-1130", TEMPATH)
    assert full_path == ""
